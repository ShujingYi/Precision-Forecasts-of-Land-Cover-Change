...
isle_net <- cbind(isle_net, exact_extract(DEM_isle, isle_net %>% st_transform(crs(DEM_isle)),'mean'))%>%rename(elevation=exact_extract.DEM_isle..isle_net.....st_transform.crs.DEM_isle....)
```
