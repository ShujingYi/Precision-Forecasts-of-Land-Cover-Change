...
isle_net <- cbind(isle_fishnet, exact_extract(DEM_isle, isle_fishnet %>% st_transform(crs(DEM_isle)),'mode'))%>%
rename(elevation=exact_extract.DEM_isle..isle_fishnet.....st_transform.crs.DEM_isle....)
```

```{r}
#join the slope data
isle_net <- cbind(isle_fishnet, exact_extract(isle_slope, isle_fishnet %>% st_transform(crs(isle_slope)),'mode'))%>%
