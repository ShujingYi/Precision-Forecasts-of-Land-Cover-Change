...
## soil
```{r}
soil <- st_read('Data/Soil/Port/port_soil.shp', crs= 'EPSG:4326')
soilclass <- soil%>%
...
```{r warning=FALSE}
port14 <- cbind(as.data.frame(port_14_10_crop),
                as.data.frame(canopy_14_mean)[-1],
                as.data.frame(road_14)[-1],
                as.data.frame(other_14_mean)[-1],
                as.data.frame(shrub_14_mean)[-1],
                as.data.frame(water_14_mean)[-1],
                as.data.frame(port_14_pcnt_imperv)[-1],
                as.data.frame(port_change_rc)[-1]
                #as.data.frame(isle_change)
                )

port14 <- cbind(as.data.frame(port_18_10_crop),
                as.data.frame(canopy_18_mean)[-1],
                as.data.frame(road_18)[-1],
                as.data.frame(other_18_mean)[-1],
                as.data.frame(shrub_18_mean)[-1],
                as.data.frame(water_18_mean)[-1],
                as.data.frame(port_18_pcnt_imperv)[-1]
                #as.data.frame(isle_change)
                )
...
```{r}
saveRDS(port_14, "port_14.rds")
saveRDS(port_18, "port_18.rds")
```
