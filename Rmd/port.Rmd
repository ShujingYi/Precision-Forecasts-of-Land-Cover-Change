...
```{r warning=FALSE}
port14 <-  cbind(port_14_10_crop,canopy_14_mean, road_14, other_14_mean, shrub_14_mean, water_14_mean, port_14_pcnt_imperv, port_change_rc,port_change) # change impervious(0, 1, -1) -1 is targeted
rm(canopy_14_mean, road_14, other_14_mean, shrub_14_mean, water_14_mean, port_14_pcnt_imperv, port_change_rc)

port18 <- cbind(port_18_10_crop, canopy_18_mean, road_18,other_18_mean, shrub_18_mean, water_18_mean,port_18_pcnt_imperv)
rm(canopy_18_mean, road_18, other_18_mean, shrub_18_mean, water_18_mean, port_18_pcnt_imperv)
