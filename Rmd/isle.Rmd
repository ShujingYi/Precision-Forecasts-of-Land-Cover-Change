...
```{r}
saveRDS(isle14, "isle14.rds")
saveRDS(isle18,"isle18.rds")
```
...
```{r}
isle_14 <- readRDS( "~/Github/Precision-Forecasts-of-Land-Cover-Change/Rdata/isle_14.rds")
isle_18 <- readRDS("~/Github/Precision-Forecasts-of-Land-Cover-Change/Rdata/isle_18.rds")
```
