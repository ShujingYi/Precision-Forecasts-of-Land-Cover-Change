...
```{r}
soil <- st_read('Data/Soil/James/James_soil.shp', crs= 'EPSG:4326')
soilclass <- soil%>%
...
## join all the data
```{r}
jame14 <-  cbind(jame_14_10_crop,canopy_14_mean, road_14, other_14_mean, shrub_14_mean, water_14_mean, jame_14_pcnt_imperv, jame_change_rc) # change impervious(0, 1, -1) -1 is targeted
rm(canopy_14_mean, road_14, other_14_mean, shrub_14_mean, water_14_mean, jame_14_pcnt_imperv, jame_change_rc)

jame18 <- cbind(jame_18_10_crop, canopy_18_mean, road_18,other_18_mean, shrub_18_mean, water_18_mean,jame_18_pcnt_imperv)
rm(canopy_18_mean, road_18, other_18_mean, shrub_18_mean, water_18_mean, jame_18_pcnt_imperv)
